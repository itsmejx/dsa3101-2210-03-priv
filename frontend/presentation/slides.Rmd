...
There are mainly 2 common locations where promotional booths are placed:

- Near the dairy/produce area

.pull-left[
```{r echo=FALSE}
knitr::include_graphics("images/20221021_122612.jpg")
```
]
.pull-right[
```{r echo=FALSE}
knitr::include_graphics("images/20221021_123249.jpg")
```
]
---
class: middle
- Along intersections of aisles

.pull-left[
```{r echo=FALSE}
knitr::include_graphics("images/20221021_123807.jpg")
```
]
.pull-right[
```{r echo=FALSE}
knitr::include_graphics("images/20221021_123811.jpg")
```
]
---
class: center, middle
